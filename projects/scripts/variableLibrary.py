...
# #                [
# #                    'A series of inter-related web pages usually associated with a domain.  A website is similar to an online brochure that presents information about a company, product, service or cause.  A website can be a minimum of 3 web pages', 
# #                    'A single-page website used to drive conversion online.  Conversions can relate to capturing leads, obtaining bookings or selling a product or service.', 
# #                    'As used here relates typically to a full-page advertisement in a newspaper or magazine.  It is intended multiple advertisement output formats will be developed including online display, online search, and offline.', 
# #                    'A form of advertisement intended for wide distribution either via printed copy or via attachment in electronic communication.  A flier is typically one to four pages in length and integrates imagery and design', 
# #                    'Typically a glossy image-centric communication used by organisations to promote a product, service or concept.  Brochures are typically one to ten pages in length.',
# #                ],
